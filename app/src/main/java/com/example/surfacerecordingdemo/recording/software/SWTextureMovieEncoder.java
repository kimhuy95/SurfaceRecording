...
//
//import static com.screencastomatic.app.recording.IntentKt.ACTION_PAUSE_RECORDING_BY_GPU_MONITOR;
//import static com.screencastomatic.app.recording.IntentKt.ACTION_STOP_RECORDING_BY_GPU_MONITOR;
//
...
//import com.example.surfacerecordingdemo.partial.EncoderCallback;
//import com.screencastomatic.app.recording.recorder.partial.EncoderConfig;
//import com.screencastomatic.app.recording.recorder.partial.MainFrameRect;
//import com.screencastomatic.app.recording.recorder.partial.RecordCallback;
//import com.screencastomatic.app.recording.recorder.partial.TextureMovieEncoder;
//import com.example.surfacerecordingdemo.partial.WatermarkFrameRect;
//import com.screencastomatic.app.recording.recorder.partial.gles.EglCore;
//import com.screencastomatic.app.recording.recorder.partial.gles.Texture2dProgram;
//import com.screencastomatic.app.recording.recorder.partial.gles.WindowSurface;
//import com.screencastomatic.app.util.EvaluationState;
//import com.screencastomatic.app.util.Monitoring;
//
...
//public class SWTextureMovieEncoder implements TextureMovieEncoder, Runnable, SurfaceTexture.OnFrameAvailableListener {
...
//    private SWVideoEncoderCore mVideoEncoder;
//
...
//
//    public SWTextureMovieEncoder(Context context, @Nullable AudioEncoderConfig audioEncoderConfig) {
...
//            evaluateGPUOverLoading();
//        }
//    }
//
//    private void evaluateGPUOverLoading() {
//        if (Monitoring.evaluate() == EvaluationState.DANGER) {
//            if (!isShownDangerToast) {
//                context.sendBroadcast(new Intent(ACTION_PAUSE_RECORDING_BY_GPU_MONITOR));
//                isShownDangerToast = true;
//            }
//            return;
//        }
//
...
//
//        try {
//            mVideoEncoder = new SWVideoEncoderCore(context, mVideoWidth, mVideoHeight, config.mBitRate, config.mOutputFile, config.mEnableAudio, audioEncoderConfig);
//            mVideoEncoder.setRecordCallback(mRecordCallback);
//            if (mCallback != null) {
...
//            mSurfaceTexture.updateTexImage();
//            Monitoring.reset();
//            setupAwakeFromThrottling();
//        }, config.mDelayMs);
//    }
//
//    /**
//     * Although the error has been limited, it still happens from time to time.
//     * Consider the possibility of installing a passive monitoring mechanism.
//     * When an error occurs, the application recovery or restart mechanism will be executed.
//     */
//    private void setupAwakeFromThrottling() {
//        throttlingTimer = new Timer();
//        throttlingTimer.schedule(new TimerTask() {
//            @Override
//            public void run() {
//               if(isRecording() && Monitoring.getLastDurationInInMillis() > 10000) {
//                   // TODO: write code to handle Throttling EGL Production: fence error
//                   // We can consider the ability to stop recording or restart the application
//                   Timber.tag(TAG).d("GPUDebug AwakeFromThrottling");
//                   context.sendBroadcast(new Intent(ACTION_STOP_RECORDING_BY_GPU_MONITOR));
//               }
//            }
//        }, 0, 1000);
//    }
...
//        private WeakReference<SWTextureMovieEncoder> mWeakEncoder;
//
//        public EncoderHandler(SWTextureMovieEncoder encoder) {
//            mWeakEncoder = new WeakReference<SWTextureMovieEncoder>(encoder);
//        }
//
...
//
//            SWTextureMovieEncoder encoder = mWeakEncoder.get();
//            if (encoder == null) {
//                return;
//            }
//
